...
export default function ContactForm() {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/40 z-50">
      ...
      <div
        className="relative  rounded-3xl shadow-2xl p-10 w-[350px] md:w-[540] text-white bg-cover bg-center"
      ...
      >
        ...
        >
          ...
          <div className="flex gap-3">
            ...
            <select className="w-1/2 p-3 rounded-md text-black text-sm border border-black border-2 focus:outline-none bg-blue-50">
