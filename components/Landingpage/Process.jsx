...
const Process = () => {
  return (
    <section className="relative bg-[#DDD4D0] w-full  h-[300px] md:h-[600px] overflow-hidden">
      {/* ✅ Full-Screen Background Video with Cover Effect */}
      <div className="absolute inset-0 w-full h-full">
        <iframe
          title="vimeo-player"
          src="https://player.vimeo.com/video/1026395622?h=38eb24ff69&autoplay=1&loop=1&muted=1&background=1"
          className="absolute top-1/2 left-1/2 min-w-full min-h-full -translate-x-1/2 -translate-y-1/2 scale-125"
          frameBorder="0"
