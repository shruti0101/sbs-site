        ...
        >
          ...
          <div className="flex gap-3 text-white">
            <input
              ...
              className="w-1/2 p-3 placeholder-white rounded-md backdrop-blur-xs text-white text-md border border-white border-2 bg-transparent focus:outline-none"
            />

            <select
              className="w-1/2 p-3 rounded-md backdrop-blur-xs text-white text-md border border-white border-2 focus:outline-none bg-transparent "
              defaultValue=""
            >
              ...
              <option className="text-black" value="Paper Plate Making Machine">
